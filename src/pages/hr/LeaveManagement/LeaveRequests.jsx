...
/**
 * LeaveRequests — HR leave management, under the HR module.
 *
 * Functionally the same as the admin LeaveListPage (RLS grants HR the same
 * access via leave_requests_select/update_admin_hr), restored here because the
 * admin Workspace section is now admin-only — without this page HR would have
 * no way to approve/reject leave. Reuses leave.service + the shared leave
 * components, same race-guarded debounced load pattern as the other lists.
 */

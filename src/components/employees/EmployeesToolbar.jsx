...
/**
 * EmployeesToolbar — search input + status / department filters + an
 * optional "Add employee" CTA on the right.
 *
 * Stateless: the parent owns `query`, `status`, `departmentId` and passes
 * setters back in. That keeps the URL/storage syncing out of this file
 * and lets the same toolbar drop into Reports later.
 */
